...
class ResConfigSettings(models.TransientModel):
    ...
    display_total_variant_stock = fields.Boolean(
        related="pos_config_id.display_total_variant_stock",
        string="Display Total Variant Stock on Product Card",
        readonly=False)
    ...
    picking_type_location_id = fields.Many2one(
        related='pos_config_id.picking_type_location_id', readonly=False, string="Default Source Location")

    picking_type_location_id_num = fields.Integer(
        related='pos_config_id.picking_type_location_id_num', string="Default Source Location id")
